...
// visit my repo, https://github.com/EricMegalovania/Leetcode-Parser-Cpp for more details
...
// TODO: copy Solution class from leetcode

#ifdef LOCAL_LEETCODE
void solve(){
	auto [TODO]=read<TODO>();
	writeRawNoSpace(Solution().TODO);
}
int main(){
#ifndef LOCAL
